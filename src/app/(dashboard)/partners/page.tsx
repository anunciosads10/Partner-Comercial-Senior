...
import { partners, Partner } from "@/lib/data";
...
function getTierBadgeVariant(tier: Partner['tier']): 'default' | 'secondary' | 'outline' | 'destructive' {
  switch (tier) {
    case 'Platinum':
      return 'default';
    case 'Gold':
...
function getStatusBadgeVariant(status: Partner['status']): 'default' | 'secondary' | 'destructive' {
  switch (status) {
    case 'Active':
      return 'default';
    case 'Suspended':
