...
import { identifyAtRiskPartners, IdentifyAtRiskPartnersOutput } from "@/ai/flows/identify-at-risk-partners";
...
export function AtRiskPartners() {
  ...
  const [result, setResult] = useState<IdentifyAtRiskPartnersOutput | null>(null);
