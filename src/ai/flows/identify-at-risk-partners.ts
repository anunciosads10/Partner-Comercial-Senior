...
export type IdentifyAtRiskPartnersInput = z.infer<typeof IdentifyAtRiskPartnersInputSchema>;
...
export type IdentifyAtRiskPartnersOutput = z.infer<typeof IdentifyAtRiskPartnersOutputSchema>;

export async function identifyAtRiskPartners(
  input: IdentifyAtRiskPartnersInput
): Promise<IdentifyAtRiskPartnersOutput> {
